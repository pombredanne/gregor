...
func TestUsage(t *testing.T) {
	...
	testBadUsage(t, []string{"gregor", "-bind-address", "localhost:9911", "-incoming-address", "localhost:9911", "-aws-set-external-addr"}, ebu, "incoming-address specified with aws-set-external-addr")
